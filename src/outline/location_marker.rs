...
impl Outline for LocationMarker {
    fn base<T>(classes: Vec<&str>) -> Node<T> {
        svg![
            ...
            path![attrs!(
            At::from("d") => "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z",
            At::from("stroke-linecap") => "round",
            At::from("stroke-linejoin") => "round",
            At::from("stroke-width") => "2",
            ),],
            path![attrs!(
            At::from("d") => "M15 11a3 3 0 11-6 0 3 3 0 016 0z",
            At::from("stroke-linecap") => "round",
            At::from("stroke-linejoin") => "round",
            At::from("stroke-width") => "2",
            ),],
