...
impl Outline for VolumeOff {
    fn base<T>(classes: Vec<&str>) -> Node<T> {
        svg![
            ...
            At::from("d") => "M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z",
            At::from("stroke-linecap") => "round",
            At::from("stroke-linejoin") => "round",
            At::from("stroke-width") => "2",
            ),],
            path![attrs!(
            At::from("d") => "M17 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2",
            At::from("stroke-linecap") => "round",
            At::from("stroke-linejoin") => "round",
            At::from("stroke-width") => "2",
            ),],
